...
def EmployeeList(request):
    ...
    for emp in Empobjs:
        emp_id = emp['EmpID']
        # print("--------------------------------------------------------------")
        # print("EmployeeID is here", emp_id)
        work_detail = work_details_dict.get(emp_id, {})
        # print(f"WorkDetails is here of EmpID:{emp_id}-->", work_detail)
        # print("--------------------------------------------------------------")
        # print("All work EmpIDs:", list(work_details.values_list('EmpID', flat=True)))
...
#     if prev_effective:
#         prev_effective.EffectiveTo = Promotionobj.date_of_promtion
...
#         per_month = ps.RevisedSal or 0
#         per_annum = per_month * 12
#         total_ctc += per_annum
...
# def UpdateEmployeeSalaryGridByPromotion(EmpID, Promotionobj, OrganizationID, UserID):
    ...
    #     update_employee_ctc(EmpID, OrganizationID, UserID, total_ctc / 12)
    #     # UpdateCTC(EmpID, OrganizationID, UserID)
    #     print("Employee salary grid updated with new entries successfully.")
    # except Exception as e:
    #     print(f"An error occurred: {str(e)}")
