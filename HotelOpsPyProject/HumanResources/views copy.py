...
def EmployeeList(request):
    ...
    if not selected_org_id or selected_org_id == "all":
        ...
        selected_org_id = int(selected_org_id)  # convert string to integer

    selected_emp_status = request.GET.get("EmpStatus", "all")
    selected_department = request.GET.get("Departments")
    ...
    print("selected org is here::", selected_org_id)
    print("selected_department org is here::", selected_department)
    context = {
        ...
        'selected_division_new': 'Corporate Office',
...
def Salary_Details_Settlement(request,EmpID,OID):
    ...
    # SalaryTitles = SalaryTitle_Master.objects.all()
    Emobj = None  
    ...
    if request.method == "POST":
        ...
        for i in range(total_titles):
            ...
            if title_id:
                ...
                detail, created = Salary_Detail_Master.objects.get_or_create(
                    EmpID=EmpID,
                    Salary_title_id=title_id,
                    Effective=effective_obj,
                    OrganizationID=OID,
...
def get_salary_effective_data(request, EmpID, OID):
    ...
    effective_data = Salary_Details_Effective.objects.filter(
        ...
        OrganizationID=OID,
        EmpID=EmpID
    ).values("id", "EffectiveFrom", "CTC", "EmpID", "OrganizationID")
