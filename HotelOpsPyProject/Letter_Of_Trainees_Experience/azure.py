...
from .models  import Trainees_Experience_Employee_Detail
...
def save_file_id_to_db(id,file_name):
    new_file = Trainees_Experience_Employee_Detail.objects.get(id=id)
...
def upload_file_to_blob(file,file_id):
    ...
    file_name = f"TraineesExperinceLetter/{file_prefix}{ext}"
