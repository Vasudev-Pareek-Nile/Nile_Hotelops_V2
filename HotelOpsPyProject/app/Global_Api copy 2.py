...
from HumanResources.models import EmployeeWorkDetails, Salary_Detail_Master
from .models import *
...
def New_Joiners_Api(request):
    ...
    print("the first OID are here", OID)
    ...
    try:
        ...
        Resignations = (
            ...
            .values(
                ...
                "OrganizationID", "Date_Of_res",'Emp_Code'
            )
        )
        ...
        equal_years = request.GET.get("TenureYears") or 0
        equal_months = request.GET.get("TenureMonths") or 0
...
def Get_Level_From_Code(request, Code, OID):
    EmpData = EmployeeMaster.objects.filter(EmployeeCode=Code, OrganizationID=OID).only('Level')
    return EmpData
...
#             final_list.append({
#                 "SDL": org_map.get(j["OrganizationID"], ""),
#                 "Name": j["Name"],
#                 "Desi": j["Designation"],
#                 "Dept": j["Dept"],
#                 "Tenure": tenure,
