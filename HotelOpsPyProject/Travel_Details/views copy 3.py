...
#     Travel_TravelRequest_ID_str = request.GET.get('Travel_TravelRequest_ID', '')
#     Travel_TravelRequest_ID = int(Travel_TravelRequest_ID_str) if Travel_TravelRequest_ID_str else None
...
#             messages.success(request, "Travel Entries deleted successfully.")
#             params = urlencode({'success': 'True', 'message': 'Travel request deleted successfully.'})
#             # return redirect(f"{reverse('Travel_Details_List')}?{params}")
#             return redirect(f"{reverse('Create_Travel_Request')}?Travel_Entry_ID={Travel_TravelRequest_ID}&OID={User_OrganizationID}")
...
#     if Travel_Entry_ID:
#         try:
#             # Soft delete TravelEntry objects
#             entries = TravelEntry.objects.filter(
#                 organization_id=User_OrganizationID,
#                 travel_request_id=Travel_Entry_ID,
#                 is_delete=False
