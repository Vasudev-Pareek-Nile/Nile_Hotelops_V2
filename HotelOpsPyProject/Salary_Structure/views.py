...
def Handle_SalaryStructure(request):
    if request.method == 'POST':
        ...
        TypeOrder = request.POST.getlist('TypeOrder[]')  # may be shorter
        TitleOrder = request.POST.getlist('TitleOrder[]')  # may be shorter
        ...
        for i in range(len(display_names)):
            ...
            if row_id:  
                ...
                obj.TitleOrder = TitleOrder[i]
                obj.TypeOrder = TypeOrder[i]
                obj.save()
            else: 
...
def Salary_Calc_Ready(request, Orgid):
    ...
    # print("the salary details is here::", salary_details)
