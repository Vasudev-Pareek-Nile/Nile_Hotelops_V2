...
#         results_dict.appdate(results)
#     else:
#         results_dict = {}
#         print("No POST data received, Request is not POST")
...
#     return JsonResponse({"results_dict": results_dict})
...
def salary_Calc_post_value(request):
    ...
    if request.method == "POST":
        ...
        results_dict.update(calculate_salary(employee_input))

    # 🔹 Merge DB info + calculated results
    merged_data = []
    for item in salary_titles:
