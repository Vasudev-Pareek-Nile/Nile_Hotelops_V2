...
class LETTEROFEXPERIENCE(models.Model):
...
# Emp Details  Model
class LETTEROFEXPERIENCEEmployeeDetail(models.Model):
...
class LETTEROFEXPERIENCEDeletedFileofEmployee(models.Model):
    LETTEROFEXPERIENCEEmployeeDetail = models.ForeignKey(LETTEROFEXPERIENCEEmployeeDetail, on_delete=models.CASCADE)
    file_id = models.CharField(max_length=200,null=True)
    file_name = models.CharField(max_length=200, null=True)
