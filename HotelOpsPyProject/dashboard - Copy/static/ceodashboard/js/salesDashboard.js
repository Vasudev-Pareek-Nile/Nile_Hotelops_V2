                ...
                .then(data => {
                    var calendar = new FullCalendar.Calendar(calendarEl, {
                        ...
                        events: data.Table.map(event => ({
                            ...event,
                            classNames: ['my-custom-event'] // Assign custom class to each event
                        })),
                ...
                data.GlitchData.forEach(item => {
                    const row = `
                        <tr data-status="${item.Status}">
                            ...
                            <td><a target="_blank" style="color:blue" class="fa fa-eye" href="/Glitch/Home/ExportGlitch?I=20241006228586&amp;O=1501"></a> <a target="_blank" style="color:Red" class="fa fa-file-pdf-o" href="/Glitch/Home/ExportGlitch?I=20241006228586&amp;O=${item.ID}&amp;IsD=True"></a></td>  
                        </tr>
                    `;
        ...
        function ToggleGlitch(status) {
             filterTableByStatus(status); // Filter the table based on the status
        }
                ...
                data.CompRoomData.forEach(item => {
                    const row = `
                        <tr>
                            ...
                            <td><a target="_blank" style="color:Red" class="fa fa-file-pdf-o" href="/CompRoom/Home/ViewPDF?VID=${item.ID}"></a></td>
                        </tr>
                    `;
                    tableBody.innerHTML += row;
                });
            ...
            try {
                ...
                data.IncidentData.forEach(item => {
                    ...
                    <tr>
                        ...
                        <td><a target="_blank" style="color:blue" class="fa fa-eye" href="/IncidentReport/Home/ViewDetails?VID=20241006216901"></a> <a target="_blank" style="color:Red" class="fa fa-file-pdf-o" href="/IncidentReport/Home/ViewDetails?VID=${item.ID}&amp;IsD=True"></a></td>
                    </tr>
                `;
                tableBody.innerHTML += row;
                });
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            HotelRevenueDataChart(firstButton, 1);
            HotelRevenueData(firstButton, 1);
            CEORevenueTotalData(firstButton, 1);
            forecastDatachart(firstButton, 1);
            forecastAdrDatachart(firstButton, 1);
            payMasterDatachart(firstButton, 1);
            SalesContractChartData(firstButton, 1);
            DSRChart(firstButton, 1);
            out_of_orderChart(firstButton, 1);
            total_SRMSRequestChart(firstButton, 1);
            RDGuestMetChart(firstButton, 1);
            ArCollectionDatachart(firstButton, 1);
            PpmRoomsDatachart(firstButton, 1);
            TopSRMSrequestChart(firstButton, 1);
            total_SRMSRequestCompletionChart(firstButton, 1);
            maintanceBreakdown(firstButton, 1);
            trainingHoursDatachart(firstButton, 1);
            warningLettersDatachart(firstButton, 1);
            cateringSaleDatachart(firstButton, 1);
    ...
    return number.toLocaleString('en-IN');
        ...
        async function BindHLPReportChart() {
        ...
        async function maintanceBreakdown(button,rangeType){
        ...
        async function HotelRevenueDataChart(button, rangeType) {
            selectedTimeRange = rangeType;
            updateButtonState(button);
            const RT = rangeType;
        ...
        async function CEORevenueTotalData(button, timeRange) {
            updateButtonState(button);
        ...
        async function total_SRMSRequestCompletionChart(button, rangeType) {
            updateButtonState(button);
            const RT = rangeType;
        ...
        async function TopSRMSrequestChart(button, rangeType) {
            updateButtonState(button);
        ...
        async function PpmRoomsDatachart(button, rangeType) {
            updateButtonState(button);
            const RT = rangeType;
            ...
            try {
                ...
                try {
                    ...
                    row.innerHTML = `
                        ...
                        <td><a class="btn btn-primary" target="_blank" href="/PPMChecklist/Home/Entry/${detail.EntryID}">View</a></td>
        ...
        async function trainingHoursDatachart(button, rangeType) {
            updateButtonState(button);
            const RT = rangeType;
        ...
        async function warningLettersDatachart(button, rangeType) {
            updateButtonState(button);
            const RT = rangeType;
        ...
        async function cateringSaleDatachart(button, rangeType) {
            updateButtonState(button);
            const RT = rangeType;
        ...
        async function RDGuestMetChart(button, rangeType) {
            updateButtonState(button);
            const RT = rangeType;
        ...
        async function total_SRMSRequestChart(button, rangeType) {
            updateButtonState(button);
            const RT = rangeType;
        ...
        async function DSRChart(button, rangeType) {
            updateButtonState(button);
            const RT = rangeType;
        ...
        async function forecastDatachart(button, rangeType) {
            updateButtonState(button);
            const RT = rangeType;
        ...
        async function forecastAdrDatachart(button, rangeType) {
            updateButtonState(button);
            const RT = rangeType;
        ...
        async function payMasterDatachart(button, rangeType) {
            updateButtonState(button);
            const RT = rangeType;
        ...
        async function SalesContractChartData(button, rangeType) {
            updateButtonState(button);
            const RT = rangeType;
        ...
        async function ArCollectionDatachart(button, rangeType) {
            updateButtonState(button);
            const RT = rangeType;
