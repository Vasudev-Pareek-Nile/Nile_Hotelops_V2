...
class Indemnity_Accommodation_Employee_Detail(models.Model):
...
class Indemnity_Accommodation_Deleted_File_Of_Employee(models.Model):
    Data_PrivacyExperience_Employee_Detail = models.ForeignKey(Indemnity_Accommodation_Employee_Detail, on_delete=models.CASCADE)
    file_id = models.CharField(max_length=200,null=True)
