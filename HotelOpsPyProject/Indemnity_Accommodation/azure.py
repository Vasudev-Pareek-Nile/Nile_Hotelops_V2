...
from .models  import Indemnity_Accommodation_Employee_Detail
...
def save_file_id_to_db(id,file_name):
    new_file = Indemnity_Accommodation_Employee_Detail.objects.get(id=id)
...
def upload_file_to_blob(file,file_id):
    ...
    file_name = f"Indemnity_Accommodation_Letter/{file_prefix}{ext}"
