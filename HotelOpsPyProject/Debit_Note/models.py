...
class Debit_Note_Employee_Detail(models.Model):
...
class Debit_Note_Deleted_File_Of_Employee(models.Model):
    Data_PrivacyExperience_Employee_Detail = models.ForeignKey(Debit_Note_Employee_Detail, on_delete=models.CASCADE)
    file_id = models.CharField(max_length=200,null=True)
