# Generated by Django 4.1.7 on 2023-06-28 04:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ModifyDateTime', models.DateField(default=datetime.date.today)),
                ('IsDelete', models.BooleanField(default=False)),
                ('PLUtilitiesEntryMaster', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ExpenseReport.plutilitiesentrymaster')),
                ('PLUtilitiesMaster', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ExpenseReport.plutilitiesmaster')),
            ],
        ),
    ]
