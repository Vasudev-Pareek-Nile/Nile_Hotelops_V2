...
def  PLUtilitiesList(request):
    ...
    return render(request, 'HPLUtilities/PLUtilitiesList.html' ,{'mem' :mem }) 
...
def delete_PLUtilities (request,id):
    ...
    mem.ModifyBy = 1
    mem.save()
    return(redirect('/HvarianceReport/PLUtilitiesList'))
...
def PutilitiesEntry(request):
    ...
    CYear = today.year
    CMonth = today.month
    return render(request, 'HPLUtilities/PLUtilitiesEntry.html' ,{'mem':mem,'CYear':range(CYear,2020,-1),'CMonth':CMonth})
...
def PLUtilitiesEdit(request , id):
    ...
    CYear = today.year
    CYear = int(CYear)+1   
    return render(request,'HPLUtilities/PLUtilitiesEdit.html',{'mem':mem , 'mem1':mem1 ,'CYear':range(2022,CYear) })

def PLUtilitiesView(request , id):
  
    template_path = "HPLUtilities/PLUtilitiesviewdata.html"
    mem1 = PLUtilitiesEntryDetails.objects.filter(PLUtilitiesEntryMaster=id,IsDelete = False).select_related("PLUtilitiesMaster")
    mem = PLUtilitiesEntryMaster.objects.get(id = id)
...
def  EngList(request):
    ...
    return render(request, 'HEngineering/EngineeringList.html' ,{'mem' :mem }) 
...
def PL_EngineeringEntry(request):
    ...
    if request.method == 'POST':
        ...
        return(redirect('/HvarianceReport/EngList'))
    today = datetime.date.today()
    CYear = today.year
    CMonth = today.month
    mem = PL_Engineering_Master.objects.filter(IsDelete=False)
    return render(request, 'HEngineering/Engineering_Entry.html' ,{'mem':mem , 'CYear':range(CYear,2020,-1),'CMonth':CMonth})
...
def EngListEdit(request , id):
    ...
    CYear = today.year
    CYear = int(CYear) +1
    return render(request,'HEngineering/EngEdit.html',{'mem':mem,'mem1':mem1 , 'CYear':range(2022,CYear)})

def Engviewdata(request, id):
    template_path = "HEngineering/Engviewdata.html"
    mem1 = PL_Engineering_EntryDetails.objects.filter(PL_Engineering_Entry_Master=id , IsDelete = False).select_related("PL_Engineering_Master")
    mem = PL_Engineering_Entry_Master.objects.get(id = id)
...
def SMList(request):
    ...
    return render(request, 'HSM/SMList.html' ,{'mem' :mem }) 
...
def SMEntry(request):    
    ...
    if request.method == 'POST':
        ...
        return(redirect('/HvarianceReport/SMList'))
    today = datetime.date.today()
    CYear = today.year
    CMonth = today.month       
    mem =  SM_SalesExpenseMaster.objects.filter(IsDelete = False)  
    mem1 = SM_MarketingExpenseMaster.objects.filter(IsDelete = False)
    return render(request , 'HSM/SMEntry.html' ,{'mem':mem ,'mem1':mem1, 'CYear':range(CYear,2020,-1),'CMonth':CMonth})
...
def SMEdit(request,id):
    ...
    CYear = today.year
    CYear = int(CYear)+1
    return render(request , 'HSM/SMEdit.html' , {'mem1' :mem1 ,'mem2':mem2, 'mem':mem ,'CYear':range(2022,CYear)})

 
def SMviewdata(request, id):
    template_path = "HSM/SMviewdata.html"
    mem1 = SM_SalesEntryDetails.objects.filter(SM_SaleMarketingEntryMaster=id , IsDelete = False).select_related("SM_SalesExpenseMaster")
    mem = SM_SaleMarketingEntryMaster.objects.get(id = id)
    mem2 = SM_MarketingEntryDetails.objects.filter(SM_SaleMarketingEntryMaster=id , IsDelete = False).select_related("SM_MarketingExpenseMaster")
...
def ITList(request):
    ...
    return render(request, 'HIT/ITList.html' ,{'mem' :mem }) 
...
def ITEntry(request):    
    ...
    if request.method == 'POST':
        ...
        return(redirect('/HvarianceReport/ITList'))
    today = datetime.date.today()
    CYear = today.year
    CMonth = today.month     
    mem =  ItServiceMaster.objects.filter(IsDelete = False)  
    mem1 = ItSystemExpenseMaster.objects.filter(IsDelete = False)
    return render(request , 'HIT/ITEntry.html' ,{'mem':mem ,'mem1':mem1, 'CYear':range(CYear,2020,-1),'CMonth':CMonth})
...
def ITEdit(request,id):
    ...
    CYear = today.year
    CYear = int(CYear)+1
    return render(request , 'HIT/ITEdit.html' , {'mem1' :mem1 ,'mem2':mem2, 'mem':mem ,'CYear':range(2022,CYear)})

def ITviewdata(request, id):
    template_path = "HIT/ITviewdata.html"
    mem1 = It_ServiceEntryDetails.objects.filter(IT_EntryMaster=id , IsDelete = False).select_related("ItServiceMaster")
    mem = IT_EntryMaster.objects.get(id = id)
    mem2 = It_SystemExpenseEntryDetails.objects.filter(IT_EntryMaster=id , IsDelete = False).select_related("ItSystemExpenseMaster")
...
def AG_SecurityList(request):
    ...
    return render(request, 'HAG_Security/AG_SecurityList.html' ,{'mem' :mem }) 
...
def AG_SecurityEntry(request):
    ...
    if request.method == 'POST':
        ...
        return(redirect('/HvarianceReport/AG_SecurityList'))
    today = datetime.date.today()
    CYear = today.year
    CMonth = today.month       
    mem =  AG_SecurityMaster.objects.filter(IsDelete = False)  
    return render(request , 'HAG_Security/AG_SecurityEntry.html' ,{'mem':mem ,'CYear':range(CYear,2020,-1),'CMonth':CMonth})
...
def AG_SecurityEdit(request,id):
    ...
    CYear = int(CYear)+1
    mem = AG_SecurityEntryMaster.objects.get(id = id)
    return render(request , 'HAG_Security/AG_SecurityEdit.html' , {'mem' :mem , 'mem1':mem1 ,'CYear':range(2022,CYear)})

def AG_Securityviewdata(request, id):
    template_path = "HAG_Security/AG_Securityviewdata.html"
    mem1 = AG_SecurityEntryDetails.objects.filter(AG_SecurityEntryMaster=id , IsDelete = False).select_related("AG_SecurityMaster")
    mem = AG_SecurityEntryMaster.objects.get(id = id)
...
def AG_HRList(request):
    ...
    return render(request, 'HAG_HR/AG_HRList.html' ,{'mem' :mem }) 
...
def AG_HREntry(request):
    ...
    if request.method == 'POST':
        ...
        return(redirect('/HvarianceReport/AG_HRList'))
    today = datetime.date.today()
    CYear = today.year
    CMonth = today.month       
    mem =  AG_HRMaster.objects.filter(IsDelete = False)  
    return render(request , 'HAG_HR/AG_HREntry.html' ,{'mem':mem , 'CYear':range(CYear,2020,-1),'CMonth':CMonth})
...
def AG_HREdit(request,id):
    ...
    CYear = today.year
    CYear = int(CYear) +1
    return render(request , 'HAG_HR/AG_HREdit.html' , {'mem' :mem ,'mem1':mem1 , 'CYear':range(2022,CYear)})


def AG_HRviewdata(request, id):
    template_path = "HAG_HR/AG_HRviewdata.html"
    mem1 = AG_HREntryDetails.objects.filter(AG_HREntryMaster=id , IsDelete = False).select_related("AG_HRMaster")
    mem = AG_HREntryMaster.objects.get(id = id)
...
def AG_AnalysisList(request):
    ...
    return render(request, 'HAG_Analysis/AG_AnalysisList.html' ,{'mem' :mem }) 
...
def AG_AnalysisEntry(request):
    ...
    if request.method == 'POST':
        ...
        return(redirect('/HvarianceReport/AG_AnalysisList'))
    today = datetime.date.today()
    CYear = today.year
    CMonth = today.month
    mem = AG_Analysis_Master.objects.filter(IsDelete=False)
    return render(request, 'HAG_Analysis/AG_AnalysisEntry.html' ,{'mem':mem , 'CYear':range(CYear,2020,-1),'CMonth':CMonth})
...
def AG_AnalysisEdit(request,id):
    ...
    mem = AG_AnalysisEntryMaster.objects.get(id = id)
    return render(request ,'HAG_Analysis/AG_AnalysisEdit.html' , {'mem' :mem , 'mem1':mem1 ,'CYear':range(2022,CYear)})

def AG_Analysisviewdata(request, id):
    template_path = "HAG_Analysis/AG_Ratioviewdata.html"
    mem1 = AG_AnalysisEntryDetail.objects.filter(AG_AnalysisEntryMaster=id , IsDelete = False).select_related("AG_Analysis_Master")
    mem = AG_AnalysisEntryMaster.objects.get(id = id)
...
def Total_AGList(request):
    ...
    return render(request, 'HTotal_AG/Total_AGList.html' ,{'mem' :mem }) 
...
def Total_AGEntry(request):    
    ...
    if request.method == 'POST':
        ...
        return(redirect('/HvarianceReport/Total_AGList'))
    today = datetime.date.today()
    CYear = today.year
    CMonth = today.month       
    mem =  Total_AG_Master.objects.filter(IsDelete = False)  
    return render(request , 'HTotal_AG/Total_AGEntry.html' ,{'mem':mem , 'CYear':range(CYear,2020,-1),'CMonth':CMonth})
...
def Total_AGEdit(request,id):
    ...
    mem = Total_AGEntryMaster.objects.get(id = id)
    return render(request , 'HTotal_AG/Total_AGEdit.html' , {'mem1' :mem1 , 'mem':mem ,'CYear':range(2022,CYear)})


def Total_AGviewdata(request, id):
    template_path = "HTotal_AG/Total_AGviewdata.html"
    mem1 = Total_AGEntryDetails.objects.filter(Total_AGEntryMaster=id , IsDelete = False).select_related("Total_AG_Master")
    mem = Total_AGEntryMaster.objects.get(id = id)
...
def Rental_IncomeList(request):
    ...
    return render(request, 'HRental_Income/Rental_IncomeList.html' ,{'mem' :mem }) 
...
def Rental_IncomeEntry(request):
    ...
    if request.method == 'POST':
        ...
        return(redirect('/HvarianceReport/Rental_IncomeList'))
    today = datetime.date.today()
    CYear = today.year
    CMonth = today.month
    mem = Rental_Other_IncomeMaster.objects.filter(IsDelete=False)
    return render(request, 'HRental_Income/Rental_IncomeEntry.html' ,{'mem':mem , 'CYear':range(CYear,2020,-1),'CMonth':CMonth})
...
def Rental_IncomeEdit(request,id):
    ...
    CYear = today.year
    CYear = int(CYear)+1
    return render(request ,'HRental_Income/Rental_IncomeEdit.html' , {'mem1' :mem1 , 'mem':mem ,'CYear':range(2022,CYear)})


 
def Rental_Incomeviewdata(request, id):
    template_path = "HRental_Income/Rental_Incomeviewdata.html"
    mem1 = Rental_Other_IncomeEntryDetail.objects.filter(Rental_Other_IncomeEntryMaster=id , IsDelete = False).select_related("Rental_Other_IncomeMaster")
    mem = Rental_Other_IncomeEntryMaster.objects.get(id = id)
...
def OOD_LaundryList(request):
    ...
    return render(request, 'HOOD_Laundry/OOD_LaundryList.html' ,{'mem' :mem }) 
...
def OOD_LaundryEntry(request):
    ...
    if request.method == 'POST':
        ...
        return(redirect('/HvarianceReport/OOD_LaundryList'))
    today = datetime.date.today()
    CYear = today.year
    CMonth = today.month
    mem = OOD_LaundryMaster.objects.filter(IsDelete=False)
    return render(request, 'HOOD_Laundry/OOD_LaundryEntry.html' ,{'mem':mem , 'CYear':range(CYear,2020,-1),'CMonth':CMonth})
...
def OOD_LaundryEdit(request,id):   
    ...
    CYear = today.year
    CYear = int(CYear)+1
    return render(request ,'HOOD_Laundry/OOD_LaundryEdit.html' , {'mem1' :mem1 , 'mem':mem ,'CYear':range(2022,CYear)})

  
def OOD_Laundryviewdata(request, id):
    template_path = "HOOD_Laundry/OOD_Laundryviewdata.html"
    mem1 = OOD_LaundryEntryDetail.objects.filter(OOD_LaundryEntryMaster=id , IsDelete = False).select_related("OOD_LaundryMaster")
    mem = OOD_LaundryEntryMaster.objects.get(id = id)
...
def OOD_TransportList(request):
    ...
    return render(request, 'HOOD_Transport/OOD_TransportList.html' ,{'mem' :mem }) 
...
def OOD_TransportEntry(request):   
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            cursor.close()
        return(redirect('/HvarianceReport/OOD_TransportList'))
    today = datetime.date.today()
    CYear = today.year
    CMonth = today.month
    mem =  OOD_TransportMaster.objects.filter(IsDelete=False)
    return render(request, 'HOOD_Transport/OOD_TransportEntry.html' ,{'mem':mem , 'CYear':range(CYear,2020,-1),'CMonth':CMonth}) 
...
def OOD_TransportEdit(request,id):   
    ...
    CYear = today.year
    CYear = int(CYear)+1
    return render(request ,'HOOD_Transport/OOD_TransportEdit.html' , {'mem1' :mem1 , 'mem':mem ,'CYear':range(2022,CYear)})


def OOD_Transportviewdata(request, id):
    template_path = "HOOD_Transport/OOD_Transportviewdata.html"
    mem1 = OOD_TransportEntryDetail.objects.filter(OOD_TransportEntryMaster=id , IsDelete = False).select_related("OOD_TransportMaster")
    mem = OOD_TransportEntryMaster.objects.get(id = id)
...
def OOD_HealthList(request):
    ...
    return render(request, 'HOOD_Health/OOD_HealthList.html' ,{'mem' :mem }) 
...
def OOD_HealthEntry(request):  
    ...
    if request.method == 'POST':
        ...
        return(redirect('/HvarianceReport/OOD_HealthList'))
    today = datetime.date.today()
    CYear = today.year
    CMonth = today.month
    mem = OOD_HealthMaster.objects.filter(IsDelete=False)
    return render(request, 'HOOD_Health/OOD_HealthEntry.html' ,{'mem':mem , 'CYear':range(CYear,2020,-1),'CMonth':CMonth})
...
def OOD_HealthEdit(request,id):   
    ...
    CYear = today.year
    CYear = int(CYear)+1
    return render(request ,'HOOD_Health/OOD_HealthEdit.html' , {'mem1' :mem1 , 'mem':mem ,'CYear':range(2022,CYear)})


def OOD_Healthviewdata(request, id):
    template_path = "HOOD_Health/OOD_Healthviewdata.html"
    mem1 = OOD_HealthEntryDetail.objects.filter(OOD_HealthEntryMaster=id , IsDelete = False).select_related("OOD_HealthMaster")
    mem = OOD_HealthEntryMaster.objects.get(id = id)
...
def Total_OODList(request):
    ...
    return render(request, 'HTotal_OOD/Total_OODList.html' ,{'mem' :mem }) 
...
def Total_OODEntry(request):  
    ...
    if request.method == 'POST':
        ...
        return(redirect('/HvarianceReport/Total_OODList'))
    today = datetime.date.today()
    CYear = today.year
    CMmonth = today.month
    mem = Total_OODMaster.objects.filter(IsDelete=False)
    return render(request, 'HTotal_OOD/Total_OODEntry.html' ,{'mem':mem , 'CYear':range(CYear,2020,-1),'CMmonth':CMmonth})  
...
def Total_OODEdit(request,id):    
    ...
    CYear = today.year
    CYear = int(CYear)+1
    return render(request ,'HTotal_OOD/Total_OODEdit.html' , {'mem1' :mem1 , 'mem':mem ,'CYear':range(2022,CYear)})


def Total_OODviewdata(request, id):
    template_path = "HTotal_OOD/Total_OODviewdata.html"
    mem1 = Total_OODEntryDetail.objects.filter(Total_OODEntryMaster=id , IsDelete = False).select_related("Total_OODMaster")
    mem = Total_OODEntryMaster.objects.get(id = id)
...
def FB_BanquetList(request):
    ...
    return render(request, 'HFB_Banquet/FB_BanquetList.html' ,{'mem' :mem })
...
def FB_BanquetEntry(request):  
    ...
    if request.method == 'POST':
        ...
        return(redirect('/HvarianceReport/FB_BanquetList'))
    today = datetime.date.today()
    CYear = today.year
    CMonth = today.month
    mem = FB_BanquetMaster.objects.filter(IsDelete=False)
    return render(request, 'HFB_Banquet/FB_BanquetEntry.html' ,{'mem':mem , 'CYear':range(CYear,2020,-1),'CMonth':CMonth})
...
def FB_BanquetEdit(request,id):   
    ...
    CYear = today.year
    CYear = int(CYear)+1
    return render(request ,'HFB_Banquet/FB_BanquetEdit.html' , {'mem1' :mem1 , 'mem':mem ,'CYear':range(2022,CYear)})


def FB_Banquetviewdata(request, id):
    template_path = "HFB_Banquet/FB_Banquetviewdata.html"
    mem1 = FB_BanquetEntryDetail.objects.filter(FB_BanquetEntryMaster=id , IsDelete = False).select_related("FB_BanquetMaster")
    mem = FB_BanquetEntryMaster.objects.get(id = id)
...
def FB_IRDList(request):
    ...
    return render(request, 'HFB_IRD/FB_IRDList.html' ,{'mem' :mem })
...
def FB_IRDEntry(request):  
    ...
    if request.method == 'POST':
        ...
        return(redirect('/HvarianceReport/FB_IRDList'))
    today = datetime.date.today()
    CYear = today.year
    CMonth = today.month
    mem = FB_IRDMaster.objects.filter(IsDelete=False)
    return render(request, 'HFB_IRD/FB_IRDEntry.html' ,{'mem':mem , 'CYear':range(CYear,2020,-1) ,'CMonth':CMonth})
...
def FB_IRDEdit(request,id):   
    ...
    CYear = today.year
    CYear = int(CYear)+1
    return render(request ,'HFB_IRD/FB_IRDEdit.html' , {'mem1' :mem1 , 'mem':mem ,'CYear':range(2022,CYear)})


def FB_IRDviewdata(request, id):
    template_path = "HFB_IRD/FB_IRDviewdata.html"
    mem1 = FB_IRDEntryDetail.objects.filter(FB_IRDEntryMaster=id , IsDelete = False).select_related("FB_IRDMaster")
    mem = FB_IRDEntryMaster.objects.get(id = id)
...
def Outlet_1List(request):
    ...
    return render(request, 'HOutlet_1/Outlet_1List.html' ,{'mem' :mem }) 
...
def Outlet_1Entry(request):  
    ...
    if request.method == 'POST':
        ...
        return(redirect('/HvarianceReport/Outlet_1List'))
    today = datetime.date.today()
    CYear = today.year
    CMonth = today.month
    mem = Outlet_1Master.objects.filter(IsDelete=False)
    return render(request, 'HOutlet_1/Outlet_1Entry.html' ,{'mem':mem , 'CYear':range(CYear,2020,-1),'CMonth':CMonth})
...
def Outlet_1Edit(request,id):   
    ...
    CYear = today.year
    CYear = int(CYear)+1
    return render(request ,'HOutlet_1/Outlet_1Edit.html' , {'mem1' :mem1 , 'mem':mem ,'CYear':range(2022,CYear)})


def Outlet_1viewdata(request, id):
    template_path = "HOutlet_1/Outlet_1viewdata.html"
    mem1 = Outlet_1EntryDetail.objects.filter(Outlet_1EntryMaster=id , IsDelete = False).select_related("Outlet_1Master")
    mem = Outlet_1EntryMaster.objects.get(id = id)
...
def Outlet_2List(request):
    ...
    return render(request, 'HOutlet_2/Outlet_2List.html' ,{'mem' :mem }) 
...
def Outlet_2Entry(request):  
    ...
    if request.method == 'POST':
        ...
        return(redirect('/HvarianceReport/Outlet_2List'))
    today = datetime.date.today()
    CYear = today.year
    CMonth= today.month
    mem = Outlet_2Master.objects.filter(IsDelete=False)
    return render(request, 'HOutlet_2/Outlet_2Entry.html' ,{'mem':mem , 'CYear':range(CYear,2020,-1),'CMonth':CMonth})    
...
def Outlet_2Edit(request,id):   
    ...
    CYear = today.year
    CYear = int(CYear)+1
    return render(request ,'HOutlet_2/Outlet_2Edit.html' , {'mem1' :mem1 , 'mem':mem ,'CYear':range(2022,CYear)})


def Outlet_2viewdata(request, id):
    template_path = "HOutlet_2/Outlet_2viewdata.html"
    mem1 = Outlet_2EntryDetail.objects.filter(Outlet_2EntryMaster=id , IsDelete = False).select_related("Outlet_2Master")
    mem = Outlet_2EntryMaster.objects.get(id = id)
...
def Outlet_3List(request):
    ...
    return render(request, 'HOutlet_3/Outlet_3List.html' ,{'mem' :mem }) 
...
def Outlet_3Entry(request):  
    ...
    if request.method == 'POST':
        ...
        return(redirect('/HvarianceReport/Outlet_3List'))
    today = datetime.date.today()
    CYear = today.year
    CMonth= today.month
    mem = Outlet_3Master.objects.filter(IsDelete=False)
    return render(request, 'HOutlet_3/Outlet_3Entry.html' ,{'mem':mem , 'CYear':range(CYear,2020,-1),'CMonth':CMonth})   
...
def Outlet_3Edit(request,id):   
    ...
    CYear = today.year
    CYear = int(CYear)+1
    return render(request ,'HOutlet_3/Outlet_3Edit.html' , {'mem1' :mem1 , 'mem':mem ,'CYear':range(2022,CYear)})


def Outlet_3viewdata(request, id):
    template_path = "HOutlet_3/Outlet_3viewdata.html"
    mem1 = Outlet_3EntryDetail.objects.filter(Outlet_3EntryMaster=id , IsDelete = False).select_related("Outlet_3Master")
    mem = Outlet_3EntryMaster.objects.get(id = id)
...
def Outlet_4List(request):
    ...
    return render(request, 'HOutlet_4/Outlet_4List.html' ,{'mem' :mem }) 
...
def Outlet_4Entry(request):  
    ...
    if request.method == 'POST':
        ...
        return(redirect('/HvarianceReport/Outlet_4List'))
    today = datetime.date.today()
    CYear = today.year
    CMonth = today.month
    mem = Outlet_4Master.objects.filter(IsDelete=False)
    return render(request, 'HOutlet_4/Outlet_4Entry.html' ,{'mem':mem , 'CYear':range(CYear,2020,-1),'CMonth':CMonth})
...
def Outlet_4Edit(request,id):   
    ...
    CYear = today.year
    CYear = int(CYear)+1
    return render(request ,'HOutlet_4/Outlet_4Edit.html' , {'mem1' :mem1 , 'mem':mem ,'CYear':range(2022,CYear)})    


def Outlet_4viewdata(request, id):
    template_path = "HOutlet_4/Outlet_4viewdata.html"
    mem1 = Outlet_4EntryDetail.objects.filter(Outlet_4EntryMaster=id , IsDelete = False).select_related("Outlet_4Master")
    mem = Outlet_4EntryMaster.objects.get(id = id)
...
def Outlet_5List(request):
    ...
    return render(request, 'HOutlet_5/Outlet_5List.html' ,{'mem' :mem })     
...
def Outlet_5Entry(request):  
    ...
    if request.method == 'POST':
        ...
        return(redirect('/HvarianceReport/Outlet_5List'))
    today = datetime.date.today()
    CYear = today.year
    CMonth= today.month
    mem = Outlet_3Master.objects.filter(IsDelete=False)
    return render(request, 'HOutlet_5/Outlet_5Entry.html' ,{'mem':mem , 'CYear':range(CYear,2020,-1),'CMonth':CMonth})     
...
def Outlet_5Edit(request,id):   
    ...
    CYear = today.year
    CYear = int(CYear)+1
    return render(request ,'HOutlet_5/Outlet_5Edit.html' , {'mem1' :mem1 , 'mem':mem ,'CYear':range(2022,CYear)})


def Outlet_5viewdata(request, id):
    template_path = "HOutlet_5/Outlet_5viewdata.html"
    mem1 = Outlet_5EntryDetail.objects.filter(Outlet_5EntryMaster=id , IsDelete = False).select_related("Outlet_5Master")
    mem = Outlet_5EntryMaster.objects.get(id = id)
...
def Total_FBList(request):
    ...
    return render(request, 'HTotal_FB/Total_FBList.html' ,{'mem' :mem })     
...
def Total_FBEntry(request):  
    ...
    if request.method == 'POST':
        ...
        return(redirect('/HvarianceReport/Total_FBList'))
    today = datetime.date.today()
    CYear = today.year
    CMmonth = today.month
    mem = Total_FBMaster.objects.filter(IsDelete=False)
    return render(request, 'HTotal_FB/Total_FBEntry.html' ,{'mem':mem , 'CYear':range(CYear,2020,-1),'CMmonth':CMmonth})  
...
def PL_RoomsList(request):
    ...
    return render(request, 'HPL_Rooms/PL_RoomsList.html' ,{'mem' :mem })   
...
def PL_RoomsEntry(request):  
    ...
    if request.method == 'POST':
        ...
        return(redirect('/HvarianceReport/PL_RoomsList'))
    today = datetime.date.today()
    CYear = today.year
    CMmonth = today.month
    mem = PL_RoomsMaster.objects.filter(IsDelete=False)
    return render(request, 'HPL_Rooms/PL_RoomsEntry.html' ,{'mem':mem , 'CYear':range(CYear,2020,-1),'CMmonth':CMmonth})                                                                  
...
def PL_RoomsEdit(request,id):    
    ...
    CYear = today.year
    CYear = int(CYear)+1
    return render(request ,'HPL_Rooms/PL_RoomsEdit.html' , {'mem1' :mem1 , 'mem':mem ,'CYear':range(2022,CYear)})     

def PL_Roomsviewdata(request, id):
    template_path = "HPL_Rooms/PL_Roomsviewdata.html"
    mem1 = PL_RoomsEntryDetail.objects.filter(PL_RoomsEntryMaster=id , IsDelete = False).select_related("PL_RoomsMaster")
    mem = PL_RoomsEntryMaster.objects.get(id = id)
...
def PL_SummaryList(request):
    ...
    return render(request, 'HPL_Summary/PL_SummaryList.html' ,{'mem' :mem }) 
...
def PL_SummaryEntry(request):  
    ...
    if request.method == 'POST':
        ...
        return(redirect('/HvarianceReport/PL_SummaryList'))
    today = datetime.date.today()
    CYear = today.year
    CMmonth = today.month
    mem = PL_SummaryMaster.objects.filter(IsDelete=False)
    return render(request, 'HPL_Summary/PL_SummaryEntry.html' ,{'mem':mem , 'CYear':range(CYear,2020,-1),'CMmonth':CMmonth})  
...
def PL_SummaryEdit(request,id):    
    ...
    CYear = today.year
    CYear = int(CYear)+1
    return render(request ,'HPL_Summary/PL_SummaryEdit.html' , {'mem1' :mem1 , 'mem':mem ,'CYear':range(2022,CYear)})

def PL_Summaryviewdata(request, id):
    template_path = "HPL_Summary/PL_Summaryviewdata.html"
    mem1 = PL_SummaryEntryDetail.objects.filter(PL_SummaryEntryMaster=id , IsDelete = False).select_related("PL_SummaryMaster")
    mem = PL_SummaryEntryMaster.objects.get(id = id)
