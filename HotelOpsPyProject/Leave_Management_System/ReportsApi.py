...
from .Attendance_Pages import days_in_selected_month



def Monthly_Attendence_Report_Leave_Pdf_View(request):
...
#     # Render HTML
#     # template = get_template("EMP_PAY/Reports_Page/Audit_Attendance_Report_Pdf_View.html")
#     # html = template.render(context)

#     # # Create PDF
#     # pdf_file = HTML(string=html, base_url=request.build_absolute_uri()).write_pdf(
#     #     stylesheets=[CSS(string='body { font-family: Arial; font-size: 10px; }')]
#     # )

#     # # Send as downloadable response
#     # response = HttpResponse(pdf_file, content_type='application/pdf')
#     # # response['Content-Disposition'] = f'filename="Audit_Trail_Attendance_Report_{month_name}_{year}.pdf"'
#     # response['Content-Disposition'] = f'attachment; filename="Audit_Trail_Attendance_Report_{month_name}_{year}.pdf"'
#     # return response
