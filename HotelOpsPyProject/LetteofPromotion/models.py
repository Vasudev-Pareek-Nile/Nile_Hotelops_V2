...
class PromotionLetterEmployeeDetail(models.Model):
    ...
    Promotiondepartment = models.CharField(max_length=100,blank=False,null=False)
    ...
    PWI = models.BooleanField(default=False)
...
class PromotionSalaryDetails(models.Model):
    PromotionLetterEmployeeDetail = models.ForeignKey(PromotionLetterEmployeeDetail, on_delete=models.CASCADE)
