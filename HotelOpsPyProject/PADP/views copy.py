...
def PADPApprove(request):
    ...
    if selected_month == 'All':
        ...
        entry_query = Entry_Master.objects.filter(IsDelete=False, CreatedDateTime__year=selected_year, CreatedDateTime__month=selected_month, **padp_filter)
    ...
    if request.method == "POST":
        ...
        if DataFrom == "APADP":
            ...
            padp = APADP.objects.create(
                ...
                hr_as = "Submitted",
                hr_actionOnDatetime = datetime.now(),
