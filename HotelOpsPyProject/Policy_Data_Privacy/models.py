...
# class Letter_Of_Data_PrivacyExperience(models.Model):
...
class Letter_Data_Item_Master(models.Model):
...
class Data_Privacy_Employee_Detail(models.Model):
...
class Data_Privacy_Deleted_File_Of_Employee(models.Model):
    Data_PrivacyExperience_Employee_Detail = models.ForeignKey(Data_Privacy_Employee_Detail, on_delete=models.CASCADE)
    file_id = models.CharField(max_length=200,null=True)
...
class Letter_Editor(models.Model):
    Letter_Data_Item_Master = models.ForeignKey(Letter_Data_Item_Master, on_delete=models.CASCADE)
    
    name = models.CharField(max_length=200, null=True, blank=True)
    content = models.TextField()  # This will store HTML from editor
