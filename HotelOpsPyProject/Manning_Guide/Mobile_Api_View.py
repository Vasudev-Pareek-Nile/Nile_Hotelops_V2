...
def budget_api(request):
    ...
    data = {
        # -------- ON ROLL --------
        "onroll": {
            "avg_salary": round(grandsalarydivion,2),
            "total_headcount": round(grand_total_headcount,2),
            "total_ctc": round(divisionmultiplication_result,2),
        },

        # -------- CONTRACT --------
        "contract": {
            "avg_salary": round(contractgrandsalarydivion,2),
            "total_headcount": round(Contractgrand_total_headcount,2),
            "total_ctc": round(grandContractdivisionmultiplication_result,2),
        },

        # -------- SHARED SERVICES --------
        "shared_services": {
            "avg_salary": round(Servicesgrandsalarydivion,2),
            "total_headcount": round(ServicesContractgrand_total_headcount,2),
            "total_ctc": round(Servicesgranddivisionmultiplication_result,2),
        },

        # -------- BENEFITS --------
        "benefits": {
            "avg_meal_cost": round(Avgsalarymealcoat,2),
            "meal_cost": round(meal_cost,2),

            "avg_insurance_cost": round(Avgsalaryinsurancecoat,2),
            "insurance_cost": round(Insurance_cost,2),

            "avg_total_ctc": round(Avgsalarytotalctc,2),
            "total_headcount": round(Benefitesheadtotal,2),
            "total_ctc": round(Benefitetotalctc,2),
        }
    }
    ...
    #     # -------- ON ROLL --------
    #     "onroll": {
    #         "avg_salary": grandsalarydivion,
    #         "total_headcount": grand_total_headcount,
    #         "total_ctc": divisionmultiplication_result,
    #     },

    #     # -------- CONTRACT --------
    #     "contract": {
    #         "avg_salary": contractgrandsalarydivion,
    #         "total_headcount": Contractgrand_total_headcount,
    #         "total_ctc": grandContractdivisionmultiplication_result,
    #     },

    #     # -------- SHARED SERVICES --------
    #     "shared_services": {
    #         "avg_salary": Servicesgrandsalarydivion,
    #         "total_headcount": ServicesContractgrand_total_headcount,
    #         "total_ctc": Servicesgranddivisionmultiplication_result,
    #     },

    #     # -------- BENEFITS --------
    #     "benefits": {
    #         "avg_meal_cost": Avgsalarymealcoat,
    #         "meal_cost": meal_cost,

    #         "avg_insurance_cost": Avgsalaryinsurancecoat,
    #         "insurance_cost": Insurance_cost,

    #         "avg_total_ctc": Avgsalarytotalctc,
    #         "total_headcount": Benefitesheadtotal,
    #         "total_ctc": Benefitetotalctc,
    #     }
    # }
