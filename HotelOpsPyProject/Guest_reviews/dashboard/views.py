...
def dashboard_view(request,id):
    ApiToken=request.session["ApiToken"]="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..5hAQqzMNCd4f9GtSwjZIeF5A9oFYHpo4KT7URXcVtxQ"
    if 'CEoDashboard' ==id:
...
def occupancy_chart_data(request):
    ...
    for org in organization_choices:
        ...
        try:
            ...
            org_data = OrganzationData.objects.filter(OrganizationID=OrganizationID).first() 
...
def RDGatepass(request):
    ApiToken='eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..WYxbJdpHUG0PJBdsCN4VABCDSSiYz_vPKNoJ-J29kks'
...
def CEO_ManningGuide(request):
    ...
    url=f"{main_url}CEO_ManningGuide?OID={OID}&Level={Level}"
    try:
        response = requests.get(url, headers=TOKEN_HEADERS)
        if response.status_code == 200:
            data = response.json()
