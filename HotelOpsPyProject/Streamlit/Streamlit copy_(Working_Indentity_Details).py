...
from HumanResources.models import EmployeePersonalDetails,EmployeeWorkDetails,EmployeeEmergencyInformationDetails, EmployeeAddressInformationDetails,Salary_Detail_Master, EmployeeIdentityInformationDetails
...
if selected_report == "Master Report":
    ...
    if Identity_Information_Details:
        # print("Identity_Information_Details is pressed at if::",Identity_Information_Details)
        # st.sidebar.markdown("### Identity Information")
        # show_pan = st.sidebar.checkbox("PAN Card Number")
        # show_aadhaar = st.sidebar.checkbox("Aadhaar Card Number")
        show_pan = True
        show_aadhaar = True
               
        # Identity_fields = st.sidebar.radio(
        #     "Select Identity Fields",
        #     options=["PAN Card Number", "Aadhaar Card Number"],
        #     key="appointment_status"
        # )
        # st.sidebar.checkbox("PAN Card Number")
        
        # if Identity_fields == "PAN Card Number":
        #     show_pan = True
        # elif Identity_fields == "Aadhaar Card Number":
        #     show_aadhaar = True
        # else:
        #     show_pan = True
        #     show_aadhaar = True
    else:
        # print("Identity_Information_Details is pressed at else::",Identity_Information_Details)
        show_pan = False
        show_aadhaar = False
    
    # print(f"show_pan:: {show_pan}")
    # print(f"show_aadhaar:: {show_aadhaar}")
    # print(f"------------------------------------------------")
