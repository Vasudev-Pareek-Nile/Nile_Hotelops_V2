...
from Leave_Management_System.models import Emp_Leave_Balance_Master, Leave_Type_Master
...
if user_id == [None]:
    ...
    if user_id:
        ...
        if response.status_code == 200:
            ...
            print("Page Restarted ----------------------------------------------")
            print("selected_org_id::", selected_org_id)
            print("Real Organization_id ::", st.session_state.organization_id )
