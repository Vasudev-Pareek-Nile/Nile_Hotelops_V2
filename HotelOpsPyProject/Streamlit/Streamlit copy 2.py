...
from Manning_Guide.models import *
...
from app.models import ReportModuleMaster, EmployeeMaster,OrganizationMaster
...
from django.db.models import F, Subquery, OuterRef, Value, Count, Exists, Func
import random
...
if selected_report == "Employees on Resignation":
    ...
    df_blood_data = fetch_blood_data("Blood Group Report",report_options, selected_Division, org_id,selected_department, selected_designation,selected_year, selected_months,)
    ...
    if report_type == "Master Report":
        ...
        if org_id ==  None:
            ...
            desired_order = [
                ...
                'work_departmentorg','EmployeeCode', 'full_name', 'work_department', 'work_designation', 'Level','ReportingtoDesignation', 
...
def fetch_EmployeesHistory_data(report_type, org_id, report_options, filters):
    ...
    if report_type == "Employees History":
        ...
        employee_df = pd.DataFrame(list(employees.values(
            'full_name', 'EmployeeCode', 'work_department', 'work_designation','ReportingtoDesignation', 
            'work_date_of_joining', 'work_status'
        )))
