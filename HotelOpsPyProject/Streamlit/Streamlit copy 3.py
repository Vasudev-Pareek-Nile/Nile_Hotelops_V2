...
from HumanResources.models import EmployeePersonalDetails,EmployeeWorkDetails,EmployeeEmergencyInformationDetails, EmployeeAddressInformationDetails,Salary_Detail_Master
