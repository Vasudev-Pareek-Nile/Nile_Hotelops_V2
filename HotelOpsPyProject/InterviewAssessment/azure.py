...
from .models import Assessment_Master,EmployeePersonalData,EmployeeEducationData,EmployeePreviousWorkData,EmployeeDocumentsInfoData,EmployeeIdentityInfoData
import mimetypes
...
container_name = "interviewassessment"
...
def save_file_id_to_db(id, file_name,ModelName):
    if ModelName == "Assessment_Master":
        ...
        new_file = Assessment_Master.objects.get(id=id)
        new_file.FileName = file_name
        new_file.save()
    elif ModelName == "EmployeePersonalData":
        new_file = EmployeePersonalData.objects.get(id=id)
        new_file.FileName = file_name
        new_file.save()
    elif ModelName == "EmployeeEducationData":
        new_file = EmployeeEducationData.objects.get(id=id)
        new_file.FileName = file_name
        new_file.save()
    elif ModelName  == "EmployeePreviousWorkData":     
        new_file = EmployeePreviousWorkData.objects.get(id=id)
        new_file.FileName = file_name
        new_file.save()
    elif ModelName  == "EmployeeDocumentsInfoData":     
        new_file = EmployeeDocumentsInfoData.objects.get(id=id)
        new_file.FileName = file_name
        new_file.save()
    elif ModelName  == "EmployeeIdentityInfoData_Pan":
        new_file = EmployeeIdentityInfoData.objects.get(id=id)
